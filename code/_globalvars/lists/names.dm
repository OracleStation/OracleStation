...
GLOBAL_LIST_INIT(fox_names_first, world.file2list("strings/names/fox_first.txt"))
GLOBAL_LIST_INIT(fox_names_last, world.file2list("strings/names/fox_last.txt"))
