...
GLOBAL_LIST_INIT(unathi_names_male, world.file2list("strings/names/lizard_male.txt"))
GLOBAL_LIST_INIT(unathi_names_female, world.file2list("strings/names/lizard_female.txt"))
GLOBAL_LIST_INIT(ethari_names, world.file2list("strings/names/ethari.txt"))
