...
GLOBAL_LIST_EMPTY(snouts_fox_list)
GLOBAL_LIST_EMPTY(ears_anthro_list)
...
GLOBAL_LIST_EMPTY(tails_list_fox)
GLOBAL_LIST_EMPTY(animated_tails_list_fox)
GLOBAL_LIST_EMPTY(hair_list_fox)
