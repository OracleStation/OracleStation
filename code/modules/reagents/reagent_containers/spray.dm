...
/obj/item/reagent_containers/spray/afterattack(atom/A as mob|obj, mob/user)
	...
	if(reagents.has_reagent("sacid"))
		message_admins("[ADMIN_LOOKUPFLW(user)] fired sulfuric acid from \a [src] at [area] [ADMIN_COORDJMP(T)].")
		log_game("[key_name(user)] fired sulfuric acid from \a [src] at [area] ([T.x], [T.y], [T.z]).")
