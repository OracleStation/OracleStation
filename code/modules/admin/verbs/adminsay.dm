/client/proc/cmd_admin_say(msg as text)
	...
	if(check_rights(R_ADMIN,0))
		msg = "<span class='asay'><span class='prefix'>ADMIN:</span> <EM>[key_name(usr, 1)]</EM> (<a href='?_src_=holder;adminplayerobservefollow=\ref[mob]'>FLW</A>): <span class='message'>[msg]</span></span>"
