...
/obj/item/organ/ears/on_life()
	...
	if(C.disabilities & DEAF)
		...
		if(get_damage_perc() < UNHEALING_EAR_DAMAGE)
			organ_heal_damage(0.05)
			deaf = max(deaf - 1, 0)
...
/obj/item/organ/ears/proc/adjustEarDamage(ddmg, ddeaf)//this instead of a regular organ_take_damage, because the deafness breaks everything
	organ_take_damage(ddmg)
