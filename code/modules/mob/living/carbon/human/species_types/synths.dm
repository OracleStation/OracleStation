/datum/species/synth
	...
	sexes = 0
	species_traits = list(SPECIES_ROBOTIC,NOTRANSSTING,NOBREATH,VIRUSIMMUNE,NODISMEMBER,NOHUNGER,NOPAIN,NO_BONES,NOCHANGELING) //all of these + whatever we inherit from the real species
	dangerous_existence = 1
	blacklisted = 1
	meat = null
	damage_overlay_type = "synth"
	limbs_id = "synth"
	var/list/initial_species_traits = list(SPECIES_ROBOTIC,NOTRANSSTING,NOBREATH,VIRUSIMMUNE,NODISMEMBER,NOHUNGER,NOPAIN) //for getting these values back for assume_disguise()
