/datum/species/synth
	...
	sexes = 0
	species_traits = list(NOTRANSSTING,NOBREATH,VIRUSIMMUNE,NODISMEMBER,NOHUNGER,NOPAIN,NO_BONES,SYNTHETICSPECIES) //all of these + whatever we inherit from the real species
