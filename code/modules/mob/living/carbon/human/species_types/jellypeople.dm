/datum/species/jelly
	...
	say_mod = "chirps"
	species_traits = list(SPECIES_ORGANIC,MUTCOLORS,EYECOLOR,NOBLOOD,VIRUSIMMUNE,TOXINLOVER,NO_BONES)
...
/datum/species/jelly/slime
	...
	species_traits = list(MUTCOLORS,EYECOLOR,HAIR,FACEHAIR,NOBLOOD,VIRUSIMMUNE,TOXINLOVER,NO_BONES)
	say_mod = "says"
	hair_color = "mutcolor"
	hair_alpha = 150
