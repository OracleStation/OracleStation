...
/mob/living/carbon/human/interactive/proc/doSetup()
	...
	switch(myjob.title)
		...
		if("Chief Medical Officer","Medical Doctor","Chemist","Virologist","Geneticist","Brig Physician","Paramedic")
...
/mob/living/carbon/human/interactive/proc/job2area(target)
	...
	if(T.title == "Station Engineer" || T.title == "Chief Engineer" || T.title == "Atmospheric Technician")
		return /area/engine
	if(T.title == "Chief Medical Officer" || T.title == "Medical Doctor" || T.title == "Chemist" || T.title == "Virologist" || T.title == "Geneticist" || T.title == "Paramedic")
		return /area/medical
