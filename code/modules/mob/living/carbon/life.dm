...
/mob/living/carbon/proc/breathe()
	...
	if(istype(loc, /obj/machinery/atmospherics/components/unary/cryo_cell))
		return
	if(istype(loc, /obj/item/clothing/head/mob_holder)) // Unless someone can code to check the atmosphere of the mob holding the object holding the mob, this stays.
		return
