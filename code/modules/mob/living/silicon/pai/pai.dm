...
// Various software-specific vars
	...
	var/list/possible_chassis = list("cat" = TRUE, "mouse" = TRUE, "monkey" = TRUE, "corgi" = FALSE, "fox" = TRUE, "repairbot" = TRUE, "rabbit" = TRUE)		//assoc value is whether it can be picked up.
