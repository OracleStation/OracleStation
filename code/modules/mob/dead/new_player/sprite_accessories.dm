...
/datum/sprite_accessory/tails/fox/bushy
	name = "Bushy"
	icon_state = "bushy"
	hasinner = TRUE

/datum/sprite_accessory/tails_animated/fox/bushy
	name = "Bushy"
	icon_state = "bushy"
	hasinner = TRUE

/datum/sprite_accessory/tails/fox/bushyclean
	name = "Bushy (no markings)"
	icon_state = "bushyclean"

/datum/sprite_accessory/tails_animated/fox/bushyclean
	name = "Bushy (no markings)"
	icon_state = "bushyclean"

/datum/sprite_accessory/tails/fox/short
	name = "Short"
	icon_state = "short"
	hasinner = TRUE

/datum/sprite_accessory/tails_animated/fox/short
	name = "Short"
	icon_state = "short"
	hasinner = TRUE

/datum/sprite_accessory/tails/fox/stub
	name = "Stub"
	icon_state = "stub"

/datum/sprite_accessory/tails_animated/fox/stub
	name = "Stub"
	icon_state = "stub"

/datum/sprite_accessory/tails/fox/long
	name = "Long"
	icon_state = "long"
	hasinner = TRUE

/datum/sprite_accessory/tails_animated/fox/long
	name = "Long"
	icon_state = "long"
	hasinner = TRUE

/datum/sprite_accessory/tails/fox/longclean
	name = "Long (no markings)"
	icon_state = "longclean"

/datum/sprite_accessory/tails_animated/fox/longclean
	name = "Long (no markings)"
	icon_state = "longclean"
...
/datum/sprite_accessory/snouts_fox
	icon = 'icons/mob/mutant_bodyparts.dmi'

/datum/sprite_accessory/snouts_fox/sharp
	name = "Sharp"
	icon_state = "pointed"

/datum/sprite_accessory/snouts_fox/sharplight
	name = "Sharp, Light"
	icon_state = "pointedlight"
	hasinner = TRUE

/datum/sprite_accessory/snouts_fox/round
	name = "Round"
	icon_state = "round"

/datum/sprite_accessory/snouts_fox/roundlight
	name = "Round, Light"
