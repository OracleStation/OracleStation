...
/obj/machinery/atmospherics/components/binary/circulator/verb/rotate()
	set category = "Object"
	set name = "Rotate"
	set src in view(1)
...
/obj/machinery/atmospherics/components/binary/circulator/attackby(obj/item/C, mob/user, params)
...
/obj/machinery/atmospherics/components/binary/circulator/proc/multitool_act(mob/living/user, obj/item/I)
	if(generator)
		disconnectFromGenerator()
	mode = !mode
...
/obj/machinery/atmospherics/components/binary/circulator/proc/crowbar_act(mob/user, obj/item/I)
