...
/datum/preferences/proc/load_character(slot)
	...
	S["feature_corvid_body_feathers"]		>> features["corvid_body_feathers"]
	S["feature_corvid_head_feathers"]		>> features["corvid_head_feathers"]
	...
	features["corvid_body_feathers"]	 = sanitize_inlist(features["corvid_body_feathers"], GLOB.corvid_body_feathers_list, "None")
	features["corvid_head_feathers"]	 = sanitize_inlist(features["corvid_head_feathers"], GLOB.corvid_head_feathers_list, "None")
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["feature_corvid_body_feathers"]		, features["corvid_body_feathers"])
	WRITE_FILE(S["feature_corvid_head_feathers"]		, features["corvid_head_feathers"])
