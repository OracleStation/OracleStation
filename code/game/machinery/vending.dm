...
/obj/machinery/vending/clothing
	...
	products = list(/obj/item/clothing/neck/translator/common=5, /obj/item/clothing/head/that=2, /obj/item/clothing/head/fedora=1, /obj/item/clothing/glasses/monocle=1,
