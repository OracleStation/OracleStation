...
/datum/game_mode/clockwork_cult
	...
	protected_jobs = list("AI", "Cyborg", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Blueshield", "Brig Physician", "Internal Affairs Agent") //Silicons can eventually be converted
...
/datum/game_mode/proc/equip_servant(mob/living/M) //Grants a clockwork slab to the mob, with one of each component
	...
	if(S && !QDELETED(S))
		...
		to_chat(L, "<span class='alloy italics'>If you want more information, you can find a wiki link here!</span> https://www.oraclestation.com/wiki/Clockwork_Cult")
		return TRUE
	return FALSE
