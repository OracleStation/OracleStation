...
/datum/game_mode/clockwork_cult
	...
	protected_jobs = list("AI", "Cyborg", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Blueshield", "Brig Physician") //Silicons can eventually be converted
